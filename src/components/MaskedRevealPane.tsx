...
export default function MaskedRevealPane({ src, variant = 'card' }: Props) {
  ...
  if (variant === 'stage') {
    return (
      <div
        ...
        onMouseDown={(e) => { if (!src) return; startDrag(e.clientX, e.clientY) }}
          ...
          <>
            <div className="absolute inset-0">
              ...
              <div className="absolute inset-0" style={maskStyle}>
                <div className="absolute left-1/2 top-1/2" style={imgTransform}>
                  <img
                    src={src}
                    alt="reveal"
                    draggable={false}
